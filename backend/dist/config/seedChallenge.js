...
exports.seedChallengeDays = seedChallengeDays;
const dbService_1 = require("./dbService");
async function seedChallengeDays() {
    try {
        const existingDays = await dbService_1.dbService.challengeDays.getAll();
        ...
        const daysContent = [
            {
                ...
                vocabulary: [
                    {
                        word: 'Eloquent', pronunciation: '/ˈɛləkwənt/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Resilience', pronunciation: '/rɪˈzɪlɪəns/', partOfSpeech: 'Noun', level: 'intermediate',
                    ...
                    {
                        word: 'Pragmatic', pronunciation: '/præɡˈmætɪk/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Procrastinate', pronunciation: '/prəʊˈkræstɪneɪt/', partOfSpeech: 'Verb', level: 'intermediate',
                    ...
                    {
                        word: 'Meticulous', pronunciation: '/mɪˈtɪkjʊləs/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Collaborate', pronunciation: '/kəˈlæbəreɪt/', partOfSpeech: 'Verb', level: 'intermediate',
                    ...
                    {
                        word: 'Assertive', pronunciation: '/əˈsɜːtɪv/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Articulate', pronunciation: '/ɑːˈtɪkjʊlət/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Comprehensive', pronunciation: '/ˌkɒmprɪˈhɛnsɪv/', partOfSpeech: 'Adjective', level: 'intermediate',
                    ...
                    {
                        word: 'Alleviate', pronunciation: '/əˈliːvɪeɪt/', partOfSpeech: 'Verb', level: 'intermediate',
        ...
        for (let d = 2; d <= 15; d++) {
            ...
            const dayVocab = [
                { word: `Aptitude${d}`, pronunciation: '/ˈæptɪtjuːd/', partOfSpeech: 'Noun', level: 'intermediate', englishMeaning: 'A natural ability to do something.', hindiMeaning: 'योग्यता', synonyms: ['Ability', 'Talent', 'Skill'], antonyms: ['Inability', 'Weakness', 'Lack'], exampleSentences: ['He has an aptitude for languages.', 'Tech aptitude is critical.'], commonMistakes: 'Not attitude.', memoryTrick: 'Apt + Altitude - high talent.', realLifeUsage: 'Interviews' },
                { word: `Cognition${d}`, pronunciation: '/kɒɡˈnɪʃ(ə)n/', partOfSpeech: 'Noun', level: 'intermediate', englishMeaning: 'The process of acquiring knowledge.', hindiMeaning: 'अनुभूति / समझ', synonyms: ['Perception', 'Reasoning', 'Insight'], antonyms: ['Ignorance', 'Stupidity'], exampleSentences: ['Cognition is human learning.', 'Cognitive loads are high.'], commonMistakes: 'Not recognition.', memoryTrick: 'Cog in brain.', realLifeUsage: 'Academics' },
                { word: `Fluency${d}`, pronunciation: '/ˈfluːənsi/', partOfSpeech: 'Noun', level: 'intermediate', englishMeaning: 'The quality of speaking easily and rapidly.', hindiMeaning: 'प्रवाह', synonyms: ['Articulateness', 'Eloquence', 'Flow'], antonyms: ['Hesitation', 'Stuttering'], exampleSentences: ['She speaks with fluency.', 'Daily drills ensure fluency.'], commonMistakes: 'Not fluent (noun).', memoryTrick: 'Fluid flow.', realLifeUsage: 'Coaching' },
                { word: `Establish${d}`, pronunciation: '/ɪˈstæblɪʃ/', partOfSpeech: 'Verb', level: 'intermediate', englishMeaning: 'Set up on a firm or permanent basis.', hindiMeaning: 'स्थापित करना', synonyms: ['Setup', 'Found', 'Create'], antonyms: ['Destroy', 'Abolish'], exampleSentences: ['We must establish clean standards.', 'He established the database.'], commonMistakes: 'Not stablish.', memoryTrick: 'Table setup.', realLifeUsage: 'Business' },
                { word: `Analyze${d}`, pronunciation: '/ˈænəlaɪz/', partOfSpeech: 'Verb', level: 'intermediate', englishMeaning: 'Examine methodically for explanation.', hindiMeaning: 'विश्लेषण करना', synonyms: ['Inspect', 'Audit', 'Scrutinize'], antonyms: ['Ignore', 'Synthesize'], exampleSentences: ['Analyze the log outputs.', 'She analyzed code errors.'], commonMistakes: 'Spelled analyse in UK.', memoryTrick: 'Anna-lies.', realLifeUsage: 'Engineering' },
                { word: `Synthesize${d}`, pronunciation: '/ˈsɪnθɪsaɪz/', partOfSpeech: 'Verb', level: 'intermediate', englishMeaning: 'Combine elements into a coherent whole.', hindiMeaning: 'संश्लेषण करना', synonyms: ['Combine', 'Integrate', 'Blend'], antonyms: ['Separate', 'Deconstruct'], exampleSentences: ['Synthesize findings into reports.', 'They synthesized files.'], commonMistakes: 'Not synthese.', memoryTrick: 'Syn (together) + thesis.', realLifeUsage: 'Writing' },
                { word: `Hasten${d}`, pronunciation: '/ˈheɪs(ə)n/', partOfSpeech: 'Verb', level: 'intermediate', englishMeaning: 'Be quick to do something.', hindiMeaning: 'जल्दी करना', synonyms: ['Hurry', 'Accelerate', 'Expedite'], antonyms: ['Delay', 'Slow'], exampleSentences: ['Please hasten the delivery.', 'We hastened to resolve it.'], commonMistakes: 'Silent t.', memoryTrick: 'Haste makes waste.', realLifeUsage: 'Deliveries' },
                { word: `Advocate${d}`, pronunciation: '/ˈædvəkət/', partOfSpeech: 'Noun', level: 'intermediate', englishMeaning: 'A person who publicly supports a cause.', hindiMeaning: 'वकील / समर्थक', synonyms: ['Supporter', 'Defender', 'Proponent'], antonyms: ['Opponent', 'Critic'], exampleSentences: ['He is an advocate of clean CSS.', 'She advocated the redesign.'], commonMistakes: 'Advocat.', memoryTrick: 'Ad-vote.', realLifeUsage: 'Scoping' },
                { word: `Diminish${d}`, pronunciation: '/dɪˈmɪnɪʃ/', partOfSpeech: 'Verb', level: 'intermediate', englishMeaning: 'Make or become less.', hindiMeaning: 'घटाना', synonyms: ['Reduce', 'Shrink', 'Deplete'], antonyms: ['Increase', 'Grow'], exampleSentences: ['Errors diminish user trust.', 'The streak diminished.'], commonMistakes: 'Diminsh.', memoryTrick: 'Mini size.', realLifeUsage: 'Audits' },
                { word: `Benevolent${d}`, pronunciation: '/bɪˈnɛvələnt/', partOfSpeech: 'Adjective', level: 'intermediate', englishMeaning: 'Well meaning and kindly.', hindiMeaning: 'परोपकारी', synonyms: ['Kind', 'Generous', 'Altruistic'], antonyms: ['Malevolent', 'Cruel'], exampleSentences: ['The manager is benevolent.', 'Benevolent rewards cheer teams.'], commonMistakes: 'Benevolant.', memoryTrick: 'Ben (good) + violent (not).', realLifeUsage: 'Coaching' }
            ];
            const daySeed = {
                dayNumber: d,
                vocabulary: dayVocab,
        ...
        for (const item of daysContent) {
            await dbService_1.dbService.challengeDays.create(item);
        }
